...
jQuery &&
  (function ($) {
    ...
    function n() {
      $(".minicolors-focus").each(function () {
        ...
        o.fadeOut(n.hideSpeed, function () {
          n.hide && n.hide.call(t.get(0)), i.removeClass("minicolors-focus");
        });
      });
    }
    function s(i, t, o) {
      var n = i.parents(".minicolors").find(".minicolors-input"),
        s = n.data("minicolors-settings"),
        e = i.find("[class$=-picker]"),
        r = i.offset().left,
        c = i.offset().top,
        l = Math.round(t.pageX - r),
      ...
      t.originalEvent.changedTouches &&
        ((l = t.originalEvent.changedTouches[0].pageX - r),
        ...
        i.is(".minicolors-grid")
          ...
          : e
              .stop(!0)
              .animate({ top: h + "px" }, d, s.animationEasing, function () {
                a(n, i);
              });
    }
    function a(i, t) {
      ...
      var n,
        ...
        d,
        g = i.val(),
        m = i.attr("data-opacity"),
        f = i.parent(),
        v = i.data("minicolors-settings"),
        b = f.find(".minicolors-swatch"),
        y = f.find(".minicolors-grid"),
        M = f.find(".minicolors-slider"),
        w = f.find(".minicolors-opacity-slider"),
        x = y.find("[class$=-picker]"),
        C = M.find("[class$=-picker]"),
        ...
        switch (v.control) {
          case "wheel":
            (e = y.width() / 2 - S.x),
              ...
              (g = p({ h: n, s: s, b: a })),
              M.css("backgroundColor", p({ h: n, s: s, b: 100 }));
            break;
          case "saturation":
            (n = u(parseInt(S.x * (360 / y.width()), 10), 0, 360)),
              ...
              (g = p({ h: n, s: s, b: a })),
              M.css("backgroundColor", p({ h: n, s: 100, b: a })),
          ...
          default:
            (n = u(360 - parseInt(z.y * (360 / M.height()), 10), 0, 360)),
              ...
              (a = u(100 - Math.floor(S.y * (100 / y.height())), 0, 100)),
              (g = p({ h: n, s: s, b: a })),
              y.css("backgroundColor", p({ h: n, s: 100, b: 100 }));
        }
        i.val(h(g, v.letterCase));
      }
      t.is(".minicolors-opacity-slider") &&
        ((m = v.opacity ? parseFloat(1 - D.y / w.height()).toFixed(2) : 1),
        v.opacity && i.attr("data-opacity", m)),
        b.find("SPAN").css({ backgroundColor: g, opacity: m }),
        r(i, g, m);
    }
    function e(i, t) {
      var o,
        ...
        v = g.find(".minicolors-swatch"),
        b = g.find(".minicolors-grid"),
        y = g.find(".minicolors-slider"),
        M = g.find(".minicolors-opacity-slider"),
        w = b.find("[class$=-picker]"),
        x = y.find("[class$=-picker]"),
        C = M.find("[class$=-picker]");
      switch (
        ((o = h(d(i.val(), !0), m.letterCase)),
        ...
        case "wheel":
          (c = u(Math.ceil(0.75 * n.s), 0, b.height() / 2)),
            (l = (n.h * Math.PI) / 180),
            (a = u(75 - Math.cos(l) * c, 0, b.width())),
            (e = u(75 - Math.sin(l) * c, 0, b.height())),
            w.css({ top: e + "px", left: a + "px" }),
            (e = 150 - n.b / (100 / b.height())),
            "" === o && (e = 0),
            x.css("top", e + "px"),
            y.css("backgroundColor", p({ h: n.h, s: n.s, b: 100 }));
          break;
        case "saturation":
          (a = u((5 * n.h) / 12, 0, 150)),
            (e = u(
              b.height() - Math.ceil(n.b / (100 / b.height())),
              0,
              b.height()
            )),
            w.css({ top: e + "px", left: a + "px" }),
            ...
            x.css("top", e + "px"),
            y.css("backgroundColor", p({ h: n.h, s: 100, b: n.b })),
            g.find(".minicolors-grid-inner").css("opacity", n.s / 100);
          break;
        case "brightness":
          (a = u((5 * n.h) / 12, 0, 150)),
            (e = u(
              b.height() - Math.ceil(n.s / (100 / b.height())),
              0,
              b.height()
            )),
            w.css({ top: e + "px", left: a + "px" }),
        ...
        default:
          (a = u(Math.ceil(n.s / (100 / b.width())), 0, b.width())),
            ...
            x.css("top", e + "px"),
            b.css("backgroundColor", p({ h: n.h, s: 100, b: 100 }));
      }
    ...
    function r(i, t, o) {
      ...
      (s && s.hex === t && s.opacity === o) ||
        (i.data("minicolors-lastChange", { hex: t, opacity: o }),
        n.change &&
          (n.changeDelay
    ...
    function c(i) {
      ...
      return o ? (void 0 !== n && $.extend(o, { a: parseFloat(n) }), o) : null;
    }
    function l(i, t) {
      var o = d($(i).val(), !0),
        n = b(o),
            ...
            case "settings":
              return void 0 === a
                ...
                : ($(this).each(function () {
                    ...
                    t($(this)), $(this).minicolors($.extend(!0, i, a));
                  }),
                  $(this));
            case "show":
