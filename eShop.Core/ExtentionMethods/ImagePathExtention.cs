...
namespace eShop.Core.ExtentionMethods
{
	public static class ImagePathExtention
	{
		...
		public static string PathBrandImageClient = "/BrandImage/";
		#endregion
		...
		public static string PathSliderImageClient = "/SliderImage/";
		#endregion
		...
		public static string PathCategoryImageClient = "/CategoryImage/";
		#endregion
		...
		public static string PathProductImageClient = "/ProductImage/";
		#endregion
		...
		public static string PathGalleryImageClient = "/GalleryImage/";
		#endregion
	}
}
